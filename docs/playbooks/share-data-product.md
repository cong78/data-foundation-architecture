...
| 4 | **Data Sharing Service:** generate minimized package, aliases, recipient identity, delivery binding, entitlement, expiry, and revocation controls. | Provisioning plan. |
