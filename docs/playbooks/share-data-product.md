...
| 3 | **Sharing owner:** create a sharing contract and agreement referencing exact product and contract versions. | Approved contract and agreement. |
...
| 7 | **Sharing owner:** publish and periodically reconcile agreement, entitlement, package, recipient, and activity. | Live exchange record. |
...
- Technical share is treated as the business agreement or approval record.
...
- Product, contract, agreement, package, entitlement, recipient, usage, expiry, and revocation remain correlated.
