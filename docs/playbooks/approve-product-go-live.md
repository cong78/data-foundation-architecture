...
Authoritative inputs: [Product Management Standard](../standards/data-product-management-standard.md), [Data Product Design](../architecture/data-product-design.md), and [Data Product Template](../reference-solutions/data-product-template.md).
