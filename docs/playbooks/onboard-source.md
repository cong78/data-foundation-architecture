...
Authoritative inputs: [Data Ingestion Service](../services/data-ingestion-service.md), [Data Ingestion Design](../reference-solutions/data-ingestion-design.md), and [Source Onboarding Template](../reference-solutions/source-onboarding-template.md).
