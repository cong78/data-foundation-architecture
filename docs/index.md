...
| 5 | **Deliver governed products** | [Contract Architecture](architecture/data-contract-architecture.md) · [Product Lifecycle Design](architecture/data-product-lifecycle-design.md) · [Developer Experience](architecture/data-product-developer-experience.md) | Contracted, tested, observable products that pass product go-live. |
