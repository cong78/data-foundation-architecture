...
| 6. Launch | Publish the approved version and make access requestable through governed channels. | Promote the same artifact, register ports, publish metadata, provision entitlements and emit release evidence. | Release record, portal detail, active health, support route and rollback target. |
