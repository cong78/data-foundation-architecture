...
The canonical workload document must be version-controlled, machine-validatable, environment-neutral, and exportable. Runtime-specific manifests are generated projections.
...
- Generated runtime manifests can be recreated from canonical artifacts.
