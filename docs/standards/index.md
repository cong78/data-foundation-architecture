...
| Control | Authoritative contracts with embedded product descriptors, policies, lifecycle state, and conformance evidence drive workflow and automation. |
...
| [Data Product Creation](../services/data-product-creation-service.md) | Data Product Management; Data Product Workload; Data Contract; Data Catalog and Storage; AI-Ready Data | Developer workspace, declarative runtime intent, publishing data contract with embedded portable descriptor, Unity Catalog and Delta bindings, tests, lineage, semantics, deployment, rollback, go-live gates, and AI usage policy. |
...
| Data Product Management | Proposal, review, go-live, operation, change, deprecation, retirement. | Publishing data contract with embedded descriptor, owners, gate results, SLO status, usage, incidents, lifecycle decisions. |
