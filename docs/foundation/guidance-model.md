...
<div class="decision-brief"><div><small>Use when</small><strong>You know the question but not the right page.</strong></div><div><small>Decision</small><strong>Orient, act, verify a rule, or implement a technology.</strong></div><div><small>Owner</small><strong>The reader making or supporting the decision.</strong></div><div><small>Output</small><strong>Shortest authoritative reading path.</strong></div></div>
...
| Record delivery evidence | [Templates](../delivery-templates/data-product-template.md) | Keeping approval and evidence only in presentation material. |
...
1. Start with the five-stage journey or a playbook.
2. Open architecture only for the design decision named by the playbook.
3. Open service pages for capability boundaries and standards for mandatory rules.
4. Use reference solutions only after the technology-neutral outcome is clear.
5. Finish with recorded evidence, the applicable runbook, and the next gate, not with a list of related pages.
