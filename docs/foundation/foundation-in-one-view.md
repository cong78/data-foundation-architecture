...
<div class="standards-map reference-map" role="img" aria-label="Five-stage data foundation journey">
  ...
  <section class="standards-map-lane lane-build"><div class="standards-map-cell"><small>2 · Establish</small><strong>Build the shared path</strong><p>Target structure, services, standards, controls, portal, and operating ownership.</p></div><span class="standards-map-arrow" aria-hidden="true"></span><div class="standards-map-cell standards-map-focus"><strong>Architecture Blueprint</strong><strong>Platform Architecture</strong><strong>Service Portfolio and Standards</strong></div><span class="standards-map-arrow" aria-hidden="true"></span><div class="standards-map-cell"><strong>Foundation ready</strong><p>Reusable services with owners, interfaces, controls, SLOs, and evidence.</p></div></section>
...
Every foundation service is agentic by design. The Data Service AI Assistant coordinates service specialist agents, while published contracts, policy, and deterministic service interfaces constrain and evidence their actions.
