...
| Data domain admission | `docs/architecture/data-domain-design.md` and `docs/delivery-templates/data-domain-onboarding-template.md` |
...
| Ingestion reference | `docs/architecture/data-ingestion-design.md` |
| Product creation reference | `docs/architecture/data-product-creation-design.md` |
